...
public:
  ...
  geo2d::Rectangle GetShape() const ;
  bool Collide(const GameObject& that) const override;
  bool CollideWith(const Unit& that) const override;
  bool CollideWith(const Building& that) const override;
  bool CollideWith(const Tower& that) const override;
  bool CollideWith(const Fence& that) const override;
private:
  geo2d::Rectangle shape;
};

class Tower: public GameObject {
public:
  explicit Tower(geo2d::Circle geometry);
  geo2d::Circle GetShape() const;
  bool Collide(const GameObject& that) const override;
  bool CollideWith(const Unit& that) const override;
  bool CollideWith(const Building& that) const override;
  bool CollideWith(const Tower& that) const override;
...
Unit::Unit(geo2d::Point position): shape(position){}
geo2d::Point Unit::GetShape() const {
  return shape;
}
...
bool Unit::CollideWith(const Unit& that) const {
  return geo2d::Collide(GetShape(), that.GetShape());
}
...
Building::Building(geo2d::Rectangle geometry): shape(geometry){}
geo2d::Rectangle Building::GetShape() const {
  return shape;
}
...
Tower::Tower(geo2d::Circle geometry): shape(geometry){}
geo2d::Circle Tower::GetShape() const {
  return shape;
}
...
Fence::Fence(geo2d::Segment geometry): shape(geometry){}
geo2d::Segment Fence::GetShape() const {
  return shape;
}
